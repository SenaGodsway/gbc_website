...
const LandingPage = () => {
  return (
    ...
    <section className="flex flex-col justify-start items-start md:px-12 px-4 py-18 w-full">
    <div className='mt-24'></div>
       <div className='md:w-6/12 w-full md:ml-16 ml-0'>
       ...
       <div className="text-center mx-auto mt-36 text-2xl font-bold">Core Beliefs</div>
    <div className="flex justify-start flex-col md:flex-row items-start gap-10 md:pl-12 w-full h-full text-md">
    ...
    <div className="flex md:flex-row flex-col justify-between gap-10 bg-blue-800 px-6 py-24">
      <div className="p-6 w-full md:w-[40%] text-white">
          <h1 className="mb-3 text-2xl font-bold">Our Service Times</h1>
      ...
      <div className="flex flex-col gap-3 w-[100%] md:w-[60%]">
        <span className="bg-blue-700 mb-3 p-4 rounded-lg lg:w-5/6 text-white">
        ...
        <span className="flex md:flex-row flex-col justify-between items-center gap-3 bg-blue-700 mb-3 p-4 rounded-lg lg:w-5/6 text-white" >
          <span>
              <h1>Cell Meeting</h1>
    ...
    <div className="bg-blue-800 py-32 text-white">
    ...
    <section className="py-32">
        ...
        <div className="flex md:flex-row flex-col gap-6 mx-auto w-full md:w-[90%]">
            <div className="hover:bg-slate-100 p-2 w-full cursor-pointer rounded">
                <img src={eight} alt="" />
                <span className="flex flex-col gap-1 pt-3 font-bold">
                    <h2 className=" text-sm">21 October, 2024</h2>
            ...
            <div className="hover:bg-slate-100 p-2 w-full cursor-pointer rounded">
                <img src={ten} alt="" />
                <span className="flex flex-col gap-1 pt-3 font-bold">
                    <h2 className="text-sm">14 October, 2024</h2>
        ...
        <div className="mx-auto py-32 w-full md:w-[90%]">
            <div className="p-6 text-center">
                ...
                <span className="flex md:flex-row flex-col justify-center items-center gap-6 m-6">
                  <Link to="/" className='rounded-full bg-blue-800 text-white px-12 py-4'>Contact Us</Link>
